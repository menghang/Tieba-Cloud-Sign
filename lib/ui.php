...
function loadhead($title = '') {
	...
	echo '<script src="https://cdnjscn.b0.upaiyun.com/libs/jquery/1.10.2/jquery.min.js"></script>';
	echo '<link rel="stylesheet" href="https://cdnjscn.b0.upaiyun.com/libs/twitter-bootstrap/3.2.0/css/bootstrap.min.css">';
	echo '<script src="https://cdnjscn.b0.upaiyun.com/libs/twitter-bootstrap/3.2.0/js/bootstrap.min.js"></script>';
